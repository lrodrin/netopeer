"""
This module generate XML configuration for step 1, 2 and 5
...
def generate(filename, bw, n, qam, mm, taps, num_modes):
...
if __name__ == '__main__':
    ...
    generate("edit_5.xml", 12000000000, 41, 'qam64', "LMS 6x6", 200, 3)
