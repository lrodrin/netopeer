...
from . import nominal_central_frequency


class available_frequency_slot(PybindBase):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__nominal_central_frequency = YANGDynClass(base=nominal_central_frequency.nominal_central_frequency,
                                                        is_container='container', yang_name="nominal-central-frequency",
    ...
    def _set_nominal_central_frequency(self, v, load=False):
        ...
        if hasattr(v, "_utype"):
            v = v._utype(v)
        try:
            t = YANGDynClass(v, base=nominal_central_frequency.nominal_central_frequency, is_container='container',
                             yang_name="nominal-central-frequency", parent=self, path_helper=self._path_helper,
